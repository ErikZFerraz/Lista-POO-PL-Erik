...
console.log(`\nBem-vindo ao Sistema de Administração de Pet Shops e Clínicas Veterinárias`)
...
console.log(`3 - Editar cliente existente`);
...
console.log(`21 - Top 10 clientes que mais consumiram produto / serviços em quantidade`);
console.log(`0 - Sair`);
}
...
case 0:
execucao = false;
console.log(`Operação Encerrada, volte sempre ٩(^◡^)۶`);
break;
default:
console.log(`Operação não entendida (҂⌣̀_⌣́)`);
}
