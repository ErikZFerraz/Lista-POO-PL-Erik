...
<Route path='/lista-clientes' element={<ListaCliente tema="#1f2023"/>} />
<Route path='/lista-produtos' element={<ListaProdutos tema="#1f2023"/>} />
<Route path='/lista-servicos' element={<ListaServicos tema="#1f2023"/>} />
...
<Route path='/cadastro-servico' element={<FormularioCadastroServico tema="#1f2023"/>} />
...
<Route path='/adicionar-pet' element={<AdicionarPet tema="#1f2023"/>} />
